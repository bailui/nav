...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo"><a href="/index.php?c=admin" style="color:#009688;"><h2>白鹿io后台管理</h2></a></div>
    ...
    <ul class="layui-nav layui-layout-left">
      ...
      <li class="layui-nav-item"><a href="https://www.bailuioai.com/" target = "_blank"><i class="layui-icon layui-icon-website"></i> 白鹿io官网</a></li>
      <!-- <li class="layui-nav-item"><a onclick = "support()" title = "请求技术支持" href="javascript:;"><i class="layui-icon layui-icon-help"></i> 技术支持</a></li> -->
